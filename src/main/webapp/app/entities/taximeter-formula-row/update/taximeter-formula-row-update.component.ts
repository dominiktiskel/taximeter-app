    ...
    this.taximeterFormulaService
      ...
      .pipe(
        map((taximeterFormulas: ITaximeterFormula[]) =>
          this.taximeterFormulaService.addTaximeterFormulaToCollectionIfMissing(taximeterFormulas, this.editForm.get('row')!.value)
        )
      )
