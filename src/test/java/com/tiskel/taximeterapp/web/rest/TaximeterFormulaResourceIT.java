...
class TaximeterFormulaResourceIT {
    ...
    void createTaximeterFormula() throws Exception {
        ...
        restTaximeterFormulaMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(taximeterFormula))
            )
    ...
    void putNewTaximeterFormula() throws Exception {
        ...
        restTaximeterFormulaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTaximeterFormula.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedTaximeterFormula))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingTaximeterFormula() throws Exception {
        ...
        restTaximeterFormulaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, taximeterFormula.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(taximeterFormula))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamTaximeterFormula() throws Exception {
        ...
        restTaximeterFormulaMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(taximeterFormula))
            )
    ...
    void patchNonExistingTaximeterFormula() throws Exception {
        ...
        restTaximeterFormulaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, taximeterFormula.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(taximeterFormula))
            )
            .andExpect(status().isBadRequest());
