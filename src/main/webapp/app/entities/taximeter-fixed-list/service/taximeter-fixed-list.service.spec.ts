  ...
  describe('TaximeterFixedList Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        matchingRules: TaximeterMultipickupMatchingRules.NOT_ALLOWED,
        created: currentDate,
        updated: currentDate,
      };
    });
    ...
    describe('Service methods', () => {
      ...
      describe('addTaximeterFixedListToCollectionIfMissing', () => {
        ...
        it('should add only unique TaximeterFixedList to an array', () => {
          const taximeterFixedListArray: ITaximeterFixedList[] = [{ id: 123 }, { id: 456 }, { id: 63757 }];
