  ...
  describe('TaximeterOfferItem Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call TaximeterFixedList query and add missing value', () => {
        ...
        const fixedList1: ITaximeterFixedList = { id: 35900 };
        taximeterOfferItem.fixedList1 = fixedList1;
        const fixedList2: ITaximeterFixedList = { id: 6112 };
        taximeterOfferItem.fixedList2 = fixedList2;

        const taximeterFixedListCollection: ITaximeterFixedList[] = [{ id: 97026 }];
      ...
      it('Should update editForm', () => {
        const taximeterOfferItem: ITaximeterOfferItem = { id: 456 };
        const fixedList1: ITaximeterFixedList = { id: 21546 };
        taximeterOfferItem.fixedList1 = fixedList1;
        const fixedList2: ITaximeterFixedList = { id: 94825 };
        taximeterOfferItem.fixedList2 = fixedList2;
