  ...
  describe('TaximeterFormulaRow Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call TaximeterFormula query and add missing value', () => {
        ...
        const row: ITaximeterFormula = { id: 77868 };
        taximeterFormulaRow.row = row;
        ...
        const additionalTaximeterFormulas = [row];
      ...
      it('Should update editForm', () => {
        const taximeterFormulaRow: ITaximeterFormulaRow = { id: 456 };
        const row: ITaximeterFormula = { id: 3206 };
        taximeterFormulaRow.row = row;
        ...
        expect(comp.taximeterFormulasSharedCollection).toContain(row);
      });
    });
